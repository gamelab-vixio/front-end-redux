      ...
      <div className="card story-box">
        ...
        <div className="card-body">
          ...
          <div className="bottom-button">
            ...
            <button className="btn" onClick={this.deleteStory}>
              delete story
            </button>
            {this.state.story_read.publish === 0 ? (
              <button className="btn" onClick={this.publishStory}>
                publish story
              </button>
            ) : (
              <button className="btn" onClick={this.unpublishStory}>
                unpublish story
              </button>
            )}
          </div>
        ...
        <div className="container-fluid story-detail animated fadeInDownBig">
          <div className="row no-gutters">
            <div className="col-12 col-sm-12 col-md-6 offset-md-3">
              <div className="story-detail-read">{this.renderContent()}</div>
            </div>
          </div>
        </div>
      );
